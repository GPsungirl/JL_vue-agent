  ...
  <div class="pad_5">
    ...
    <div>
      ...
      <el-table :data="tableData" v-loading="tableLoading" border stripe style="width: 100%">
        ...
        <el-table-column prop="birthday" label="出生日期" width="100px"></el-table-column>
        <el-table-column prop="agentName" label="所属机构" width></el-table-column>
        <el-table-column prop="address" label="居住地" width></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTableDataList(pageNum) {
      ...
      this.$http
        .post(
          `${commonUrl.baseUrl}/liveVideoRecord/getTravelerVideoExamine`,
          param
        )
        .then(res => {
